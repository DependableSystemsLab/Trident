; ModuleID = 'pathfinder-llfi_index.ll'
...
entry:
  ...
  %convt = bitcast %struct._IO_FILE** @stderr to i64*
  call void @profileLoad(i64* %convt, i64 3)
...
bb:                                               ; preds = %entry
  ...
  %convt4 = bitcast i32** @data to i64*
  call void @profileStore(i64* %convt4, i64 21)
  %12 = load i32* @rows, align 4, !llfi_index !22
  %convt5 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt5, i64 22)
  ...
  %convt6 = bitcast i32*** @wall to i64*
  call void @profileStore(i64* %convt6, i64 27)
  %17 = load i32* @rows, align 4, !llfi_index !28
  %convt7 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt7, i64 28)
  %18 = icmp sgt i32 %17, 0, !llfi_index !29
  %19 = load i32* @cols, align 4, !llfi_index !30
  %convt8 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt8, i64 30)
...
bb2:                                              ; preds = %bb2.bb2_crit_edge, %bb2.lr.ph
  ...
  %convt9 = bitcast i32** @data to i64*
  call void @profileLoad(i64* %convt9, i64 45)
  ...
  %convt10 = bitcast i32** %scevgep57 to i64*
  call void @profileStore(i64* %convt10, i64 50)
...
bb2.bb2_crit_edge:                                ; preds = %bb2
  ...
  %convt11 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt11, i64 54)
...
bb4:                                              ; preds = %bb2, %bb
  ...
  %convt12 = bitcast i32** @result to i64*
  call void @profileStore(i64* %convt12, i64 61)
  tail call void @srand(i32 9) nounwind, !llfi_index !62
  %31 = load i32* @rows, align 4, !llfi_index !63
  %convt13 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt13, i64 63)
  %32 = icmp sgt i32 %31, 0, !llfi_index !64
  %.pre62 = load i32* @cols, align 4, !llfi_index !65
  %convt14 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt14, i64 65)
...
bb6:                                              ; preds = %bb7.preheader, %bb6
  ...
  %convt15 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt15, i64 70)
  %scevgep48 = getelementptr i32** %33, i64 %indvar46, !llfi_index !71
  %34 = load i32** %scevgep48, align 8, !llfi_index !72
  %convt16 = bitcast i32** %scevgep48 to i64*
  call void @profileLoad(i64* %convt16, i64 72)
  ...
  %convt17 = bitcast i32* %scevgep43 to i64*
  call void @profileStore(i64* %convt17, i64 76)
  %37 = load i32* @cols, align 4, !llfi_index !77
  %convt18 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt18, i64 77)
...
bb7.bb8_crit_edge:                                ; preds = %bb6
  ...
  %convt19 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt19, i64 80)
...
bb12:                                             ; preds = %bb12, %bb13.preheader
  ...
  %convt20 = bitcast i32** @result to i64*
  call void @profileLoad(i64* %convt20, i64 100)
  %49 = load i32*** @wall, align 8, !llfi_index !101
  %convt21 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt21, i64 101)
  %50 = load i32** %49, align 8, !llfi_index !102
  %convt22 = bitcast i32** %49 to i64*
  call void @profileLoad(i64* %convt22, i64 102)
  %scevgep38 = getelementptr i32* %50, i64 %indvar35, !llfi_index !103
  %51 = load i32* %scevgep38, align 4, !llfi_index !104
  %convt23 = bitcast i32* %scevgep38 to i64*
  call void @profileLoad(i64* %convt23, i64 104)
  %scevgep37 = getelementptr i32* %48, i64 %indvar35, !llfi_index !105
  store i32 %51, i32* %scevgep37, align 4, !llfi_index !106
  %convt24 = bitcast i32* %scevgep37 to i64*
  call void @profileStore(i64* %convt24, i64 106)
  %52 = load i32* @cols, align 4, !llfi_index !107
  %convt25 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt25, i64 107)
...
bb13.bb21.preheader_crit_edge:                    ; preds = %bb12
  ...
  %convt26 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt26, i64 110)
...
bb18:                                             ; preds = %bb19.preheader, %bb18
  ...
  %convt27 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt27, i64 119)
  %scevgep32 = getelementptr i32** %57, i64 %indvar30, !llfi_index !120
  %58 = load i32** %scevgep32, align 8, !llfi_index !121
  %convt28 = bitcast i32** %scevgep32 to i64*
  call void @profileLoad(i64* %convt28, i64 121)
  %scevgep = getelementptr i32* %58, i64 %indvar, !llfi_index !122
  %59 = load i32* %scevgep, align 4, !llfi_index !123
  %convt29 = bitcast i32* %scevgep to i64*
  call void @profileLoad(i64* %convt29, i64 123)
  ...
  %convt30 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt30, i64 125)
...
bb20:                                             ; preds = %bb19.preheader, %bb18
  ...
  %convt31 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt31, i64 129)
...
bb20.bb19.preheader_crit_edge:                    ; preds = %bb20
  ...
  %convt32 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt32, i64 132)
...
entry:
  ...
  %convt = bitcast i32** @result to i64*
  call void @profileLoad(i64* %convt, i64 142)
  %1 = load i32* @cols, align 4, !llfi_index !143
  %convt1 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt1, i64 143)
  ...
  %convt2 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt2, i64 148)
  %7 = add nsw i32 %6, -1, !llfi_index !149
  %8 = icmp sgt i32 %7, 0, !llfi_index !150
  %.pre = load i32* @cols, align 4, !llfi_index !151
  %convt3 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt3, i64 151)
...
bb1:                                              ; preds = %bb6.preheader, %bb5
  ...
  %convt4 = bitcast i32* %scevgep43 to i64*
  call void @profileLoad(i64* %convt4, i64 161)
...
bb2:                                              ; preds = %bb1
  ...
  %convt5 = bitcast i32* %13 to i64*
  call void @profileLoad(i64* %convt5, i64 168)
...
bb4:                                              ; preds = %bb3
  ...
  %convt6 = bitcast i32* %scevgep48 to i64*
  call void @profileLoad(i64* %convt6, i64 176)
...
bb5:                                              ; preds = %bb4, %bb3
  ...
  %convt7 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt7, i64 181)
  %scevgep53 = getelementptr i32** %20, i64 %tmp52, !llfi_index !182
  %21 = load i32** %scevgep53, align 8, !llfi_index !183
  %convt8 = bitcast i32** %scevgep53 to i64*
  call void @profileLoad(i64* %convt8, i64 183)
  %scevgep42 = getelementptr i32* %21, i64 %indvar39, !llfi_index !184
  %22 = load i32* %scevgep42, align 4, !llfi_index !185
  %convt9 = bitcast i32* %scevgep42 to i64*
  call void @profileLoad(i64* %convt9, i64 185)
  %23 = add nsw i32 %22, %min.1, !llfi_index !186
  store i32 %23, i32* %scevgep41, align 4, !llfi_index !187
  %convt10 = bitcast i32* %scevgep41 to i64*
  call void @profileStore(i64* %convt10, i64 187)
  %24 = load i32* @cols, align 4, !llfi_index !188
  %convt11 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt11, i64 188)
...
bb6.bb7_crit_edge:                                ; preds = %bb5
  ...
  %convt12 = bitcast i32* @rows to i64*
  call void @profileLoad(i64* %convt12, i64 191)
...
bb10:                                             ; preds = %bb10, %bb11.preheader
  ...
  %convt13 = bitcast i32** @data to i64*
  call void @profileLoad(i64* %convt13, i64 215)
  %scevgep36 = getelementptr i32* %35, i64 %indvar34, !llfi_index !216
  %36 = load i32* %scevgep36, align 4, !llfi_index !217
  %convt14 = bitcast i32* %scevgep36 to i64*
  call void @profileLoad(i64* %convt14, i64 217)
  ...
  %convt15 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt15, i64 219)
...
bb12:                                             ; preds = %bb10, %bb11.preheader
  ...
  %convt16 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt16, i64 223)
...
bb14:                                             ; preds = %bb14, %bb12
  ...
  %convt17 = bitcast i32* %scevgep to i64*
  call void @profileLoad(i64* %convt17, i64 230)
  ...
  %convt18 = bitcast i32* @cols to i64*
  call void @profileLoad(i64* %convt18, i64 232)
...
bb16:                                             ; preds = %bb14, %bb12
  ...
  %convt19 = bitcast i32** @data to i64*
  call void @profileLoad(i64* %convt19, i64 236)
...
bb18:                                             ; preds = %bb17, %bb16
  ...
  %convt20 = bitcast i32*** @wall to i64*
  call void @profileLoad(i64* %convt20, i64 242)
