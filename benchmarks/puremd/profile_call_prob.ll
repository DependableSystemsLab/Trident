...
@countList = common unnamed_addr global [100000 x i64] zeroinitializer, align 32
@.str = private unnamed_addr constant [29 x i8] c"profile_call_prob_result.txt\00", align 1
@.str1 = private unnamed_addr constant [2 x i8] c"w\00", align 1
@.str2 = private unnamed_addr constant [10 x i8] c"%lld: %d\0A\00", align 1

define void @profileCall(i64 %llfiIndex) nounwind {
entry:
...
bb1:                                              ; preds = %bb2
  ...
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds [100000 x i64]* @countList, i64 0, i64 %3
...
bb4:                                              ; preds = %bb3, %entry
  ...
  %10 = getelementptr inbounds [100000 x i64]* @countList, i64 0, i64 %9
  %11 = load i64* %10, align 8
  %12 = add nsw i64 %11, 1
  %13 = getelementptr inbounds [100000 x i64]* @countList, i64 0, i64 %9
...
bb:                                               ; preds = %bb3
  ...
  %2 = getelementptr inbounds [100000 x i64]* @countList, i64 0, i64 %1
...
bb1:                                              ; preds = %bb
  ...
  %6 = getelementptr inbounds [100000 x i64]* @countList, i64 0, i64 %5
  %7 = load i64* %6, align 8
  %8 = load %struct.FILE** %f, align 8
  %9 = load i64* %i, align 8
  %10 = call i32 (%struct.FILE*, i8*, ...)* @fprintf(%struct.FILE* noalias %8, i8* noalias getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i64 %9, i64 %7) nounwind
  br label %bb2
