...
entry:
  ...
  call void @profileLoad(i64* %convt, i64 0)
  %1 = load %struct._IO_FILE** @stderr, align 8, !llfi_index !1
  %convt1 = bitcast %struct._IO_FILE** @stderr to i64*
  call void @profileLoad(i64* %convt1, i64 1)
...
bb:                                               ; preds = %entry
  ...
  %convt = bitcast i8** %argv to i64*
  call void @profileLoad(i64* %convt, i64 11)
  %2 = load %struct._IO_FILE** @stderr, align 8, !llfi_index !12
  %convt1 = bitcast %struct._IO_FILE** @stderr to i64*
  call void @profileLoad(i64* %convt1, i64 12)
...
bb1:                                              ; preds = %entry
  ...
  call void @profileLoad(i64* %convt2, i64 17)
  ...
  %convt3 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileStore(i64* %convt3, i64 20)
...
bb3:                                              ; preds = %bb1
  ...
  %convt4 = bitcast i32* %source to i64*
  call void @profileStore(i64* %convt4, i64 25)
  ...
  %convt5 = bitcast i32* @no_of_nodes to i64*
  call void @profileLoad(i64* %convt5, i64 27)
  ...
  %convt6 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileLoad(i64* %convt6, i64 36)
...
bb6:                                              ; preds = %bb4, %bb3
  ...
  %convt16 = bitcast i32* %source to i64*
  call void @profileStore(i64* %convt16, i64 61)
  store i8 1, i8* %16, align 1, !llfi_index !62
  %convt17 = bitcast i8* %16 to i64*
  call void @profileStore(i64* %convt17, i64 62)
  store i8 1, i8* %18, align 1, !llfi_index !63
  %convt18 = bitcast i8* %18 to i64*
  call void @profileStore(i64* %convt18, i64 63)
  %36 = load %struct._IO_FILE** @fp, align 8, !llfi_index !64
  %convt19 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileLoad(i64* %convt19, i64 64)
  ...
  %convt20 = bitcast i32* @edge_list_size to i64*
  call void @profileLoad(i64* %convt20, i64 66)
  ...
  %convt21 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileLoad(i64* %convt21, i64 71)
...
bb8:                                              ; preds = %bb8, %bb6
  ...
  %convt22 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileLoad(i64* %convt22, i64 81)
  ...
  %convt23 = bitcast i32* %id to i64*
  call void @profileLoad(i64* %convt23, i64 83)
  store i32 %48, i32* %scevgep103104, align 4, !llfi_index !84
  %convt24 = bitcast i32* %scevgep103104 to i64*
  call void @profileStore(i64* %convt24, i64 84)
  %49 = load i32* @edge_list_size, align 4, !llfi_index !85
  %convt25 = bitcast i32* @edge_list_size to i64*
  call void @profileLoad(i64* %convt25, i64 85)
  %50 = icmp slt i32 %tmp106, %49, !llfi_index !86
  %51 = load %struct._IO_FILE** @fp, align 8, !llfi_index !87
  %convt26 = bitcast %struct._IO_FILE** @fp to i64*
  call void @profileLoad(i64* %convt26, i64 87)
...
bb12:                                             ; preds = %bb11, %bb10
  ...
  %convt27 = bitcast i32* @no_of_nodes to i64*
  call void @profileLoad(i64* %convt27, i64 94)
...
bb16:                                             ; preds = %bb14.lr.ph, %bb12
  ...
  %convt28 = bitcast i32* %source to i64*
  call void @profileLoad(i64* %convt28, i64 109)
  ...
  %convt29 = bitcast i32* %63 to i64*
  call void @profileStore(i64* %convt29, i64 112)
  ...
  %convt30 = bitcast i32* @no_of_nodes to i64*
  call void @profileLoad(i64* %convt30, i64 114)
...
bb18:                                             ; preds = %bb31
  ...
  %convt31 = bitcast i8* %68 to i64*
  call void @profileLoad(i64* %convt31, i64 120)
...
bb19:                                             ; preds = %bb18
  ...
  %convt32 = bitcast i8* %68 to i64*
  call void @profileStore(i64* %convt32, i64 123)
  %70 = getelementptr inbounds %struct.Node* %15, i64 %67, i32 1, !llfi_index !124
  %71 = load i32* %70, align 4, !llfi_index !125
  %convt33 = bitcast i32* %70 to i64*
  call void @profileLoad(i64* %convt33, i64 125)
...
bb21.lr.ph:                                       ; preds = %bb19
  ...
  %convt34 = bitcast i32* %73 to i64*
  call void @profileLoad(i64* %convt34, i64 129)
...
bb21:                                             ; preds = %bb28, %bb21.lr.ph
  ...
  %convt35 = bitcast i32* %scevgep8081 to i64*
  call void @profileLoad(i64* %convt35, i64 147)
  ...
  %convt36 = bitcast i8* %79 to i64*
  call void @profileLoad(i64* %convt36, i64 150)
...
bb27:                                             ; preds = %bb21
  ...
  %convt37 = bitcast i32* %75 to i64*
  call void @profileLoad(i64* %convt37, i64 153)
  ...
  %convt38 = bitcast i32* %83 to i64*
  call void @profileStore(i64* %convt38, i64 156)
  %84 = getelementptr inbounds i8* %17, i64 %78, !llfi_index !157
  store i8 1, i8* %84, align 1, !llfi_index !158
  %convt39 = bitcast i8* %84 to i64*
  call void @profileStore(i64* %convt39, i64 158)
...
bb34:                                             ; preds = %bb37, %bb38.preheader
  ...
  %convt40 = bitcast i8* %scevgep66 to i64*
  call void @profileLoad(i64* %convt40, i64 172)
...
bb36:                                             ; preds = %bb34
  ...
  %convt41 = bitcast i8* %scevgep65 to i64*
  call void @profileStore(i64* %convt41, i64 177)
  store i8 1, i8* %scevgep64, align 1, !llfi_index !178
  %convt42 = bitcast i8* %scevgep64 to i64*
  call void @profileStore(i64* %convt42, i64 178)
  store i8 0, i8* %scevgep66, align 1, !llfi_index !179
  %convt43 = bitcast i8* %scevgep66 to i64*
  call void @profileStore(i64* %convt43, i64 179)
...
bb41:                                             ; preds = %bb39, %bb38.preheader
  ...
  %convt44 = bitcast i32* @no_of_nodes to i64*
  call void @profileLoad(i64* %convt44, i64 188)
...
bb43:                                             ; preds = %bb43, %bb41
  ...
  %convt45 = bitcast i32* %scevgep57 to i64*
  call void @profileLoad(i64* %convt45, i64 198)
  ...
  %convt46 = bitcast i32* @no_of_nodes to i64*
  call void @profileLoad(i64* %convt46, i64 200)
...
entry:
  ...
  %convt = bitcast i32* @no_of_nodes to i64*
  call void @profileStore(i64* %convt, i64 213)
  store i32 0, i32* @edge_list_size, align 4, !llfi_index !214
  %convt1 = bitcast i32* @edge_list_size to i64*
  call void @profileStore(i64* %convt1, i64 214)
